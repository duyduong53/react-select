  ...
  return _temp = _class = function (_Component) {
    ...
    function Async(props) {
      ...
      _this.handleInputChange = function (newValue, actionMeta) {
        var inputValue = handleInputChange(newValue, actionMeta, _this.props.onInputChange);
        _this.optionsFromCacheOrLoad(inputValue);
        return inputValue;
      };

      _this.handleMenuScrollToBottom = function () {
        if (!_this.props.pagination || _this.state.isLoading) return;
        _this.optionsFromCacheOrLoad(_this.state.inputValue, _this.state.page + 1);
      };
    ...
    createClass(Async, [{
      ...
      key: 'loadOptions',
      value: function loadOptions(inputValue, page, callback) {
        var _props = this.props,
            loadOptions = _props.loadOptions,
            pagination = _props.pagination;

        if (!loadOptions) return callback();
        var loader = pagination ? loadOptions(inputValue, page, callback) : loadOptions(inputValue, callback);
      ...
      key: 'optionsFromCacheOrLoad',
      value: function optionsFromCacheOrLoad(inputValue) {
        var _this2 = this;

        var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        var _props2 = this.props,
            cacheOptions = _props2.cacheOptions,
            pagination = _props2.pagination;

        var cache = this.optionsCache[inputValue];
        if (cacheOptions && cache && cache.options) {
          ...
          if (!pagination || pagination && (cache.page >= page || cache.hasReachedLastPage)) {
            return;
          }
        }
        ...
        this.setState({
          ...
          _this2.loadOptions(inputValue, page, function (options) {
            if (!_this2.mounted) return;
            if (options) {
              var _hasReachedLastPage = pagination && options.length === 0;
              if (page > 1) {
                options = _this2.state.loadedOptions.concat(options);
              }
              _this2.optionsCache[inputValue] = {
                options: options,
                hasReachedLastPage: _hasReachedLastPage,
                page: page
              };
            }
            if (request !== _this2.lastRequest) return;
            delete _this2.lastRequest;
            _this2.setState({
              isLoading: false,
              page: page,
              loadedInputValue: inputValue,
              ...
              passEmptyOptions: false,
              defaultOptions: page === 1 && !inputValue ? options || _this2.state.defaultOptions : _this2.state.defaultOptions
            });
          });
        });
      }
      ...
      value: function render() {
        ...
        var _props3 = this.props,
            ...
            props = objectWithoutProperties(_props3, ['loadOptions', 'pagination']);
        var _state = this.state,
        ...
        var options = !pagination && passEmptyOptions ? [] : inputValue && loadedInputValue || page > 1 ? loadedOptions : defaultOptions || [];
        return (
          // $FlowFixMe
